...
## 🌐 배포 URL
- **프로덕션**: https://d124c4e1.ai-blog-generator-v2.pages.dev
...
- **품질 향상**: 비용 증가 없이 콘텐츠 품질 20-30% 향상
...
### 1. 기본 사용
1. 웹사이트 접속: https://d124c4e1.ai-blog-generator-v2.pages.dev
2. 블로그 주제 입력
3. 대상 독자, 글의 톤 선택
4. **AI 모델**: "🧠 자동 선택 (전문가 시스템)" 권장! (또는 수동 선택)
5. **버튼 선택**: 
   - "일반 블로그 생성": 기본 고품질 콘텐츠
   - "SEO 최적화 생성 🔥": 검색엔진 최적화 + SEO 분석
6. **전문가 시스템 정보** 확인 (선택된 AI, 신뢰도, 선택 이유)
7. 생성된 콘텐츠 확인 및 복사

### 1-1. SEO 최적화 사용 (권장! 🔥)
1. "SEO 최적화" 섹션 확장
2. 핵심 키워드 입력 (예: "인공지능", "시간관리")
3. 추가 키워드 입력 (쉼표로 구분)
4. 콘텐츠 길이 선택 (짧게/보통/길게)
5. "SEO 최적화 생성" 버튼 클릭
6. **SEO 분석 대시보드** 확인:
   - SEO 점수 (/100)
   - 키워드 밀도
...
## 📝 업데이트 로그
- **v3.0 (2025-09-05)**: 🧠 **AI 전문가 시스템** 출시 - 게임체인저!
